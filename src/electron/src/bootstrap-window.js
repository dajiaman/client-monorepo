...
(function (globalThis, factory) {
  ...
  async function load(modulePaths, resultCallback, options) {
    ...
    const loaderConfig = {
      baseUrl: `${bootstrapLib.fileUriFromPath(configuration.appRoot, {
    ...
    loaderConfig.trustedTypesPolicy = window.trustedTypes?.createPolicy(
      "amdLoader",
      {
    ...
    const baseNodeModulesPath = isDev
      ? "../node_modules"
      : "../node_modules.asar";
    loaderConfig.paths = {
